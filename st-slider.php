...
function stap_slider_scripts() {
	//enqueue the style
    wp_enqueue_style( 'stap-style', constant('STAP_PLUGIN_PATH') . 'assets/css/style.css');

    //enqueue the script
    wp_enqueue_script( 'stap-script', constant('STAP_PLUGIN_PATH') . 'assets/js/script.js', array('jquery'), '0.0.1', true );
}
